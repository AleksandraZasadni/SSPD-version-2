...
\graphicspath{beamertheme/graphics/}

\begin{document}

%\captionsetup[figure]{font=small,singlelinecheck=off,justification=raggedright}

\title[Intelligent TrashCan - Structured Product and System Development Miniproject ]{Intelligent TrashCan - Structured Product and System Development Miniproject }
